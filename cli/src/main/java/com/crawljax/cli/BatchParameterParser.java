...
public class BatchParameterParser {
    ...
    private static final String DEFAULT_URL = "http://www.4chan.org";
    ...
    private static final int DEFAULT_MAX_NUMBER_STATES = 10;
    ...
    public BatchParameterParser(String[] args) {
        ...
        try {
            this.parameters = new PosixParser().parse(options, args);
